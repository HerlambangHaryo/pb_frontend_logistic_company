		...
		<div class="container">
			<div class="row justify-content-between g-5">
				...
				<div class="col-12 col-md-9">   
                    ...
                    <form class="col-12" action="{{ route($content.'.update', $Order->id ) }}" method="POST" >
                        @csrf  
                        @method('PUT')
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" 
                                            name        = "nama_pengirim" 
                                            value       =  "{{ old('nama', $Order->nama_pengirim) }}"
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" 
                                            ...
                                            value       =  "{{ old('nama', $Order->alamat_pengirim) }}"
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" 
                                            ...
                                            value       =  "{{ old('nama', $Order->provinsi_pengirim) }}"
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" 
                                            name        = "kota_pengirim" 
                                            value       =  "{{ old('nama', $Order->kota_pengirim) }}"
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" 
                                            ...
                                            value       =  "{{ old('nama', $Order->kecamatan_pengirim) }}"
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" 
                                            ...
                                            value       =  "{{ old('nama', $Order->kelurahan_pengirim) }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" 
                                            name        = "nama_penerima" 
                                            value       =  "{{ old('nama', $Order->nama_penerima) }}"
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" 
                                            ...
                                            value       =  "{{ old('nama', $Order->alamat_penerima) }}"
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" 
                                            ...
                                            value       =  "{{ old('nama', $Order->provinsi_penerima) }}"
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" 
                                            name        = "kota_penerima" 
                                            value       =  "{{ old('nama', $Order->kota_penerima) }}"
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" 
                                            ...
                                            value       =  "{{ old('nama', $Order->kecamatan_penerima) }}"
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" 
                                            ...
                                            value       =  "{{ old('nama', $Order->kelurahan_penerima) }}"
